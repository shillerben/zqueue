...
A queue-based audio player for iOS and watchOS. Import audio files from your device, organize them in a queue, and control playback from your iPhone or Apple Watch.
...
- **Persistence** — Queue and file access are preserved across app launches using SwiftData and security-scoped bookmarks
